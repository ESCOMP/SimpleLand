...
# 32 "/glade/p/work/erik/ctsm/src/dyn_subgrid/dynVarTimeUninterpMod.F90.in"
   contains
...
# 40 "/glade/p/work/erik/ctsm/src/dyn_subgrid/dynVarTimeUninterpMod.F90.in"
...
# 44 "/glade/p/work/erik/ctsm/src/dyn_subgrid/dynVarTimeUninterpMod.F90.in"
contains
  ...
  !-----------------------------------------------------------------------
# 51 "/glade/p/work/erik/ctsm/src/dyn_subgrid/dynVarTimeUninterpMod.F90.in"
  type(dyn_var_time_uninterp_type) function constructor( &
    ...
    logical, optional, intent(in) :: allow_nodata       ! Flag to allow there to be no data if the field doesn't exist on the dataset
    ...
    logical :: lallow_nodata   ! Local version of allow_nodata which is by default FALSE
    !-----------------------------------------------------------------------
    
    lallow_nodata = .false.
    if ( present(allow_nodata) )then
       lallow_nodata = allow_nodata
    end if
    ...
    call constructor%set_metadata( &
         ...
         data_shape=data_shape, allow_nodata=lallow_nodata)
...
# 101 "/glade/p/work/erik/ctsm/src/dyn_subgrid/dynVarTimeUninterpMod.F90.in"
  ...
  ! DIMS 1,2
  !-----------------------------------------------------------------------
# 112 "/glade/p/work/erik/ctsm/src/dyn_subgrid/dynVarTimeUninterpMod.F90.in"
...
# 143 "/glade/p/work/erik/ctsm/src/dyn_subgrid/dynVarTimeUninterpMod.F90.in"
...
# 143 "/glade/p/work/erik/ctsm/src/dyn_subgrid/dynVarTimeUninterpMod.F90.in"
  ...
  !-----------------------------------------------------------------------
# 150 "/glade/p/work/erik/ctsm/src/dyn_subgrid/dynVarTimeUninterpMod.F90.in"
...
# 178 "/glade/p/work/erik/ctsm/src/dyn_subgrid/dynVarTimeUninterpMod.F90.in"
